define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'testdemo/index' + location.search,
                    add_url: 'testdemo/add',
                    edit_url: 'testdemo/edit',
                    del_url: 'testdemo/del',
                    multi_url: 'testdemo/multi',
                    table: 'testdemo',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'testdemo/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
